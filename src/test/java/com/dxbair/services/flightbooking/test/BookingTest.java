...
public class BookingTest {
	...
	public void getBookingByValidId_OK() {
		...
		ResponseEntity<FlightBookingModel> bookingResponse = restTemplate.getForEntity(ApiUrls.BookingURL + bookingId, FlightBookingModel.class);
	...
	public void getBookingByInValidId_NOT_FOUND() {
		...
		ResponseEntity<String> bookingResponse = restTemplate.getForEntity(ApiUrls.BookingURL + bookingId, String.class);
